...
Game.LevelSelection.prototype = {
    ...
    create : function(){
        ...
        this.shop_butn = configObj.game.add.button(configObj.percentOfWidth(0.43),710, "spriteAtlas", this.OnShopClick, this);
        this.shop_butn.frameName = "shop_sc.png";
        this.unlock_butn = configObj.game.add.button(configObj.percentOfWidth(0.8),710, "spriteAtlas", this.OnUnlockClick, this);
        ...
        this.moreGames_butn.visible = false;
