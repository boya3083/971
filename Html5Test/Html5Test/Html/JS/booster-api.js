(function() {
	...
	function(e, t, n, r) {
		...
		s = n.Model.extend({
			...
			initialize: function(t) {
				...
				s.async = !0,
				s.src = (document.location.protocol == "https:" ? "https://ssltracker": "http://tracker") + ".honeytracks.com/Api/Javascript/v1.3/HoneyTracks_Tracker_Library.js";
				var r = e("script").get(0);
	...
	define("text!templates/advertisement/interstitial.html", [],
	function() {
	...
	define("text!templates/advertisement/banner.html", [],
	function() {
		return '<div id="banner" style="width:<%= width %>px; height:<%= height %>px;">\n	<iframe id="adContainer" src="http://ads.mocean.mobi/ad?site=<%= site %>&zone=<%= zone %>" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>\n</div>'
	}),
	define("text!templates/advertisement/teaser.html", [],
	function() {
		return '<div id="teaser" style="width:<%= width %>px; height:<%= height %>px;">\n	<iframe id="adContainer" src="http://ads.mocean.mobi/ad?site=<%= site %>&zone=<%= zone %>" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>\n</div>'
	}),
	define("text!templates/advertisement/adsense.html", [],
	function() {
	...
	define("text!templates/advertisement/portaladvertisement.html", [],
	function() {
